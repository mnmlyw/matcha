...
fn scanLineState(line_bytes: []const u8, state_in: LineState, lang: Language) LineState {
    var state = state_in;
    var i: usize = 0;
...
const zig_types = [_][]const u8{
    ...
    "f64",  "f80",  "i128",  "i16",  "i32",  "i64",  "i8",
    "isize", "noreturn", "null", "type", "u128", "u16", "u32",
    "u64",  "u8",   "undefined", "usize", "void", "anyerror",
    "anyframe", "anyopaque", "anytype",
};
